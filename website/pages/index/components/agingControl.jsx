...
class CK extends React.Component {
    ...
    componentDidMount() {
        ...
        publish('getData', { svn: 'skhg_stage', tableName: 'imap_scct_sxfx_01', data: { where: "category='" + (this.props.layer == 'ck' ? 'E' : 'I') + "' and EFFECTDATE='201801'" } }).then((res) => {
            ...
            if (this.props.layer == 'ck') {
                mdata = [
                    { layer: 'ck', name: '通关准备', top10Table: 'v_imap_scct_sxfx_e_b', style: { width: 646, height: 628 }, type: Number(e.DATAA) > temp[layer].qn ? 0 : 1, time: e.DATAA, items: [{ name: (Number(e.DATAA) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAA) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAA) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAA) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAA) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAA) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'ck', name: '货物提离', top10Table: 'v_imap_scct_sxfx_e_c', style: { width: 646, height: 628 }, type: Number(e.DATAB) > temp[layer].qn ? 0 : 1, time: e.DATAB, items: [{ name: (Number(e.DATAB) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAB) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAB) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAB) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAB) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAB) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'ck', name: '通关准备', top10Table: 'v_imap_scct_sxfx_e_d', style: { width: 646, height: 628 }, type: Number(e.DATAC) > temp[layer].qn ? 0 : 1, time: e.DATAC, items: [{ name: (Number(e.DATAC) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAC) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAC) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAC) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAC) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAC) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'ck', name: '查验作业', top10Table: 'v_imap_scct_sxfx_e_e', style: { width: 646, height: 628 }, type: Number(e.DATAD) > temp[layer].qn ? 0 : 1, time: e.DATAD, items: [{ name: (Number(e.DATAD) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAD) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAD) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAD) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAD) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAD) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'ck', name: '货物提离', top10Table: 'v_imap_scct_sxfx_e_f', style: { width: 646, height: 628 }, type: Number(e.DATAE) > temp[layer].qn ? 0 : 1, time: e.DATAE, items: [{ name: (Number(e.DATAE) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAE) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAE) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAE) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAE) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAE) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                ];
            }
            else {
                mdata = [
                    { layer: 'jk', name: '通关准备', top10Table: 'v_imap_scct_sxfx_e_b', style: { width: 691, height: 628, marginLeft: 75 }, type: Number(e.DATAB) > temp[layer].qn ? 0 : 1, time: e.DATAB, items: [{ name: (Number(e.DATAB) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAB) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAB) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAB) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAB) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAB) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'jk', name: '货物提离', top10Table: 'v_imap_scct_sxfx_e_c', style: { width: 691, height: 628, marginRight: 130 }, type: Number(e.DATAC) > temp[layer].qn ? 0 : 1, time: e.DATAC, items: [{ name: (Number(e.DATAC) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAC) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAC) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAC) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAC) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAC) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'jk', name: '通关准备', top10Table: 'v_imap_scct_sxfx_e_d', style: { width: 691, height: 628, marginRight: 30 }, type: Number(e.DATAD) > temp[layer].qn ? 0 : 1, time: e.DATAD, items: [{ name: (Number(e.DATAD) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAD) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAD) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAD) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAD) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAD) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                    { layer: 'jk', name: '查验作业', top10Table: 'v_imap_scct_sxfx_e_f', style: { width: 691, height: 628, marginRight: 75 }, type: Number(e.DATAE) > temp[layer].qn ? 0 : 1, time: e.DATAE, items: [{ name: (Number(e.DATAE) > temp[layer].qn ? '超' : '低') + '去年均值', value: Math.abs(Number(e.DATAE) - temp[layer].qn).toFixed(2), rate: (Math.abs(Number(e.DATAE) - temp[layer].qn)/temp[layer].qn*100).toFixed(0) }, { name: (Number(e.DATAE) > temp[layer].jn ? '超' : '低') + '目标值', value: Math.abs(Number(e.DATAE) - temp[layer].jn).toFixed(2), rate: (Math.abs(Number(e.DATAE) - temp[layer].jn)/temp[layer].jn*100).toFixed(0) }] },
                ];
            }
